...
export const listInfo = {
    ...
    rosettaItem2: {
        linkUrl: "#",
        iconUrl: "/assets/images/studyAssist/study-check-licence.png",
        altText: "Check licence",
        heading: "Check Your Licence"
    },
    rosettaItem3: {
        linkUrl: "#",
        iconUrl: "/assets/images/studyAssist/study-web.png",
        altText: "Web portal",
        heading: "Log in from Desktop Version"
    },
    rosettaItem4: {
        linkUrl: "#",
        iconUrl: "/assets/images/studyAssist/study-app-store.png",
        altText: "iOS download",
        heading: "Download from Apple App Store"
    },
    rosettaItem5: {
        linkUrl: "#",
        iconUrl: "/assets/images/studyAssist/study-google-play.png",
        altText: "Android download",
        heading: "Download from Google Play"
    },
    guardMeItem1: {
        linkUrl: "#",
        iconUrl: "/assets/images/healthSupport/health-clinique-icon.png",
        altText: "Clinique",
        heading: "Find a Nearby Clinique"
    },
    guardMeItem2: {
        linkUrl: "#",
        iconUrl: "/assets/images/healthSupport/health-claim-icon.png",
        altText: "Claim",
        heading: "Make a Claim After Clinique Visit"
    },
    keepMeSafeItem1: {
        linkUrl: "#",
        iconUrl: "/assets/images/healthSupport/health-mySSP-icon.png",
        altText: "mySSP",
        heading: "Download My SSP App from App Store"
    },
    keepMeSafeItem2: {
        linkUrl: "#",
        iconUrl: "/assets/images/healthSupport/health-call-icon.png",
        altText: "Hot line",
...
export const fieldTripDetail = {
    ...
    skiBoarding: {
        ...
        transportation: "School bus",
        backToMontreal: "Same day, at about 5:00 pm",
        whatToBring:
            "Lunch, snacks; Bottles of water",
        whatToWear: 
            "Snow pants (water-proof), snow gloves (water-proof), skiing goggles (optional) ",
        schedule: [
            "08:30 Departure from school",
            "09:45 Arrival at Rigaud",
    ...
    qcCity: {
        ...
        intro: "Quebec City sits on the Saint Lawrence River in Canada's mostly French-speaking Quebec province. Dating to 1608, it has a fortified colonial core, Vieux-Québec and Place Royale, with very European style stone buildings and narrow streets.",
        ...
        backToMontreal: "Same day, approximately 8:00 pm",
        whatToBring:
            "Lunch, snacks; Bottles of water; Snow pants; Water-resistent gloves (for Ice Hotel and Tubing)",
        whatToWear: 
            "Comfortable clothes with multiple layerse; Snow boots",
        schedule: [
    ...
    sugarShack: {
        ...
        transportation: "School bus",
        backToMontreal: "Same day, at about 3:00 pm",
        whatToBring:
